scnShortcodeMeta = {
	attributes : [

		{
			label : "MP4",
			id : "mp4",
			help : "mp4 format video url",
		},

		{
			label : "WEBM",
			id : "webm",
			help : "webm format video url",
		},

		{
			label : "OGV",
			id : "ogv",
			help : "ogv format video url",
		},
		{
			label : "Poster Image",
			id : "poster",
...

		{
			...
			id : "backgroundimage",
			help : "Image will shown, if your browser doesn't support video tag ",
		},
	...
	shortcode : "dt_sc_fullwidth_video"
};