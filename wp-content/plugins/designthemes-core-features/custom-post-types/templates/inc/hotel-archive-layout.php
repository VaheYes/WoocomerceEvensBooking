			...
			<div class="<?php echo esc_attr($li_class); ?>">
                <div class="hotel-item hotel-list-view">
                    <div class="hotel-thumb">
                        ...
                        <p>
						  <?php if(@array_key_exists("show-book-now", $hotel_meta) && dt_theme_option('general', 'disable-hotel-booking') == "on"): ?>
                              <a data-title="<?php the_title(); ?>" href="#booknow_wrapper" class="dt-sc-button theme-btn too-small btn-book"><?php _e('Book Now', 'dt_themes'); ?></a>
                          <?php elseif(@array_key_exists("show-book-now", $hotel_meta)): ?>
                              <a href="<?php echo dt_theme_page_permalink_by_its_template('tpl-booking.php'); ?>" class="dt-sc-button theme-btn too-small"><?php _e('Book Now', 'dt_themes'); ?></a>
                          <?php endif; ?>
                    ...
                    <div class="hotel-details">
						...
						<a href="<?php the_permalink(); ?>#hotel_map_<?php the_ID(); ?>" class="map-marker small"> <span class="red"></span><?php _e('View on Map', 'dt_themes'); ?></a><?php
     ...
     <div style="display:none;">
         <div id="booknow_wrapper" class="booknow-container">
            ...
            <form name="frmbooknow" class="booknow-frm" action="<?php echo get_template_directory_uri(); ?>/framework/booknow.php" method="post">
                ...
                <p><input type="text" name="txtdate" required="required" placeholder="<?php _e('Date of Arrival (required)', 'dt_themes'); ?>" /></p>
                <p><input type="text" name="txtphone" placeholder="<?php _e('Phone', 'dt_themes'); ?>" /></p>
