<?php
if( !function_exists('dt_theme_blog_title') ) {
...
if( !function_exists('dt_theme_render_ie_pie') ) {
...
if( !function_exists('dt_add_hotel_comment_meta_values') ) {
 ...
 *		To customize the post/page comments view.
 **/
if( !function_exists('dt_theme_hotel_comments') ) {
