	...
	*/
	...
	if( $ack == "SUCCESS" || $ack == "SUCESSWITHWARNING") 
	{
		...
		*/
		...
		dt_theme_admin_notify($token, $firstName, $lastName, $email, $resArray["AMT"], $_COOKIE['hotelid'], $_COOKIE['roomid'], $_COOKIE['checkin'], $_COOKIE['checkout'], $_COOKIE['adults'], $_COOKIE['childs'], $_COOKIE['deppercent'], $netamount);
		dt_theme_user_notify($token, $firstName, $email, $resArray["AMT"], $_COOKIE['hotelid'], $_COOKIE['roomid'], $_COOKIE['serviceids'], $_COOKIE['checkin'], $_COOKIE['checkout'], $_COOKIE['adults'], $_COOKIE['childs'], $_COOKIE['deppercent'], $netamount);
